...
# --------------------------------- model architecture -------------------------------------#
def get_on_off_nm_model_config():
    from dyngpt.nnmodel.hyperparameters import args
    args.model = 'on_off_nm'
    ...
    # args.state_upper_bound = int(190)
    # args.constrains = np.array([2, 190,190], dtype=int)
    args.state_upper_bound = int(430)
    args.constrains = np.array([2, 429,430], dtype=int)
    # --------------------------------- train nnNet -------------------------------------#
    args.bits = 1

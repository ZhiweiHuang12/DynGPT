...
plt.tight_layout()
plt.savefig(figure_path+"figure1_b.jpg")
plt.savefig(figure_path+"figure1_b.eps")
plt.savefig(figure_path+"igure1_b.pdf")
plt.close()
...
plt.savefig(figure_path + "figure1_c_{}.jpg".format(file_index[0]))
plt.savefig(figure_path + "figure1_c_{}.pdf".format(file_index[0]),bbox_inches="tight",dpi=600)
plt.savefig(figure_path + "figure1_c_{}.eps".format(file_index[0]),bbox_inches="tight")

...
plt.tight_layout()
plt.savefig(figure_dir + "_{}_figure7b_{}_observed.jpg".format(model_name,param_index),dpi=300)
plt.savefig(figure_dir + "_{}_figure7b_{}_observed.eps".format(model_name,param_index),dpi=300)
plt.savefig(figure_dir + "_{}_figure7b_{}_observed.pdf".format(model_name,param_index),dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig(figure_dir + "{}_figure7_c_f_{}.jpg".format(model_name,param_index),dpi=500)
plt.savefig(figure_dir + "{}_figure7_c_f_{}.pdf".format(model_name,param_index),dpi=500)
plt.savefig(figure_dir + "{}_figure7_c_f_{}.eps".format(model_name,param_index),dpi=500)
plt.close()
...
for param_index in param_index_li[:5]:
    ...
    plt.tight_layout()
    plt.savefig(figure_dir + "{}_figure7_ij_{}_observed.jpg".format(model_name, param_index), dpi=300)
    plt.savefig(figure_dir + "{}_figure7_ij_{}_observed.eps".format(model_name, param_index), dpi=300)
    plt.close()
...
# width_mm = 183
# width_inch = width_mm * 0.0393701
# height_inch = width_inch * 0.38 # 高度为宽度的四分之一
# # 设置图的大小
# param_index_li = range(0,observed_datas.shape[0])
# # for param_index in range(1,100):

# for param_index in param_index_li[:2]:
#     plt.clf()
#     fig = plt.figure(figsize=(width_inch, height_inch))

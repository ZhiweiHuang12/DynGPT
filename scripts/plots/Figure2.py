...
plt.tight_layout()
plt.savefig(figure_path+"{}_figure2_bcde.jpg".format(model_type),dpi=400)
plt.savefig(figure_path+"{}_figure2_bcde.eps".format(model_type))
plt.savefig(figure_path+"{}_figure2_bcde.pdf".format(model_type))
...
try:
    ...
    plt.savefig(figure_path + "{}_figure2f_{}.jpg".format(model_type,file_index[0]))
    plt.savefig(figure_path + "{}_figure2f_{}.pdf".format(model_type,file_index[0]),bbox_inches="tight",dpi=600)
    plt.savefig(figure_path + "{}_figure2f_{}.eps".format(model_type,file_index[0]),bbox_inches="tight")

...
plt.tight_layout()
plt.savefig(figure_path+"Sfigure11_b.jpg",dpi=400)
plt.savefig(figure_path+"Sfigure11_b.eps".format(model_type))
plt.savefig(figure_path+"Sfigure11_b.pdf".format(model_type))
...
for i in range(10,20,3):
    ...
    plt.savefig(figure_path + "Sfigure11_c_{}.jpg".format(file_index[0]))
    plt.savefig(figure_path + "Sfigure11_c_{}.pdf".format(file_index[0]),bbox_inches="tight",dpi=600)
    plt.savefig(figure_path + "Sfigure11_c_{}.eps".format(file_index[0]),bbox_inches="tight")

...
for param_index in param_index_li:
    ...
    plt.tight_layout()
    plt.savefig(figure_dir + "figure7_i_l_{}.jpg".format( param_index), dpi=300)
    # plt.savefig(figure_dir + "figure7_i_l_{}.eps".format( param_index), dpi=300)
    plt.savefig(figure_dir + "figure7_i_l_{}.pdf".format(param_index), dpi=300)
    plt.close()
...
for param_index in [124,560]:
    ...
    # Adjust layout and save the plots as JPG and EPS
    plt.tight_layout()
    plt.savefig(figure_dir + "figure7_m_p_{}.jpg".format(param_index), dpi=300)
    plt.savefig(figure_dir + "figure7_m_p_{}.pdf".format(param_index), dpi=300)
    plt.close()

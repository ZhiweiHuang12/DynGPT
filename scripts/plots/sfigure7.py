...
data_path = "result/{}/config6/data/".format(model_type)
...
plt.tight_layout()
plt.savefig(figure_path+"sfigureS7_bc.jpg",dpi=400)
plt.savefig(figure_path+"sfigureS7_bc.eps",dpi=400)
plt.savefig(figure_path+"sfigureS7_bc.pdf",dpi=400)
...
plt.tight_layout()
plt.savefig(figure_path + "sfigure7_d_{}.jpg".format(file_list[0]),dpi=400)
plt.savefig(figure_path + "sfigure7_d_{}.pdf".format(file_list[0]))
plt.savefig(figure_path + "sfigure7_d_{}.eps".format(file_list[0]))
plt.close()

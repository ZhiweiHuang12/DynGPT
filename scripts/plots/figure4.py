...
plt.tight_layout()
plt.savefig(figure_path+"figure4_b.jpg",dpi=400)
plt.savefig(figure_path+"figure4_b.eps",dpi=400)
plt.savefig(figure_path+"figure4_b.pdf",dpi=400)
plt.close()
...
for i in range(0,100,3):
    ...
    plt.savefig(figure_path + "figure4_c_{}.jpg".format(file_index[0]))
    plt.savefig(figure_path + "figure4_c_{}.pdf".format(file_index[0]),bbox_inches="tight",dpi=600)
    plt.savefig(figure_path + "figure4_c_{}.eps".format(file_index[0]),bbox_inches="tight")

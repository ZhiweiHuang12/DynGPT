...
plt.tight_layout()
plt.savefig(figure_path+"{}_Sfigure_b.jpg".format(model_type),dpi=400)
plt.savefig(figure_path+"{}_Sfigure_b.eps".format(model_type))
plt.savefig(figure_path+"{}_Sfigure_b.pdf".format(model_type))
plt.close()

figure_li = [3,24]
# for i in range(0,80,3):
# for i in figure_li:
file_index = [39,43,46,56]
i1,i2,i3,i4= 0,1,2,3
sub_col_index = [1,2]
...
g0 = plot_jointplot(data1_nn_x_c,data1_nn_y_c,xy_ticks,axs[0, 0],lims=[data1_x_lim,data1_y_lim],label_names = label_names,data_nn=True,cmap_name=cmap_name,cmap_limit=cmap_limit)
g1 = plot_jointplot(data1_ssa_x_c,data1_ssa_y_c,xy_ticks,axs[0, 1],lims=[data1_x_lim,data1_y_lim],label_names = label_names,cmap_name=cmap_name,cmap_limit=cmap_limit)

g2 = plot_jointplot(data2_nn_x_c,data2_nn_y_c,xy_ticks,axs[0, 2],lims=[data2_x_lim,data2_y_lim],label_names = label_names,data_nn=True,cmap_name=cmap_name,cmap_limit=cmap_limit)
g3 = plot_jointplot(data2_ssa_x_c,data2_ssa_y_c,xy_ticks,axs[0, 3],lims=[data2_x_lim,data2_y_lim],label_names = label_names,cmap_name=cmap_name,cmap_limit=cmap_limit)

g4 = plot_jointplot(data3_nn_x_c,data3_nn_y_c,xy_ticks,axs[1, 0],lims=[data3_x_lim,data3_y_lim],label_names = label_names,data_nn=True,cmap_name=cmap_name,cmap_limit=cmap_limit)
g5 = plot_jointplot(data3_ssa_x_c,data3_ssa_y_c,xy_ticks,axs[1,1],lims=[data3_x_lim,data3_y_lim],label_names = label_names,cmap_name=cmap_name,cmap_limit=cmap_limit)

g6 = plot_jointplot(data4_nn_x_c,data4_nn_y_c,xy_ticks,axs[1, 2],lims=[data4_x_lim,data4_y_lim],label_names = label_names,data_nn=True,cmap_name=cmap_name,cmap_limit=cmap_limit)
g7 = plot_jointplot(data4_ssa_x_c,data4_ssa_y_c,xy_ticks,axs[1,3],lims=[data4_x_lim,data4_y_lim],label_names = label_names,cmap_name=cmap_name,cmap_limit=cmap_limit)
...
plt.savefig(figure_path + "{}_Sfigure_c_{}.jpg".format(model_type,file_index[0]))
plt.savefig(figure_path + "{}_Sfigure_c_{}.pdf".format(model_type,file_index[0]),bbox_inches="tight",dpi=600)
plt.savefig(figure_path + "{}_Sfigure_c_{}.eps".format(model_type,file_index[0]),bbox_inches="tight")

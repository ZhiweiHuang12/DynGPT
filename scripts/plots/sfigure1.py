...
plt.tight_layout()
plt.savefig(figure_path+"sfigure1_bc.jpg",dpi=400)
plt.savefig(figure_path+"sfigure1_bc.eps",dpi=400)
plt.savefig(figure_path+"sfigure1_bc.pdf",dpi=400)
...
plt.tight_layout()
plt.savefig(figure_path + "sfigure1_d.jpg",dpi=400)
plt.savefig(figure_path + "sfigure1_d.pdf")
plt.savefig(figure_path + "sfigure1_d.eps")
plt.close()
...
plt.tight_layout()
plt.savefig(figure_path + "sfigure1_ef.eps")
plt.savefig(figure_path + "sfigure1_ef.jpg",dpi=400)
plt.savefig(figure_path + "sfigure1_ef.pdf")
plt.close(fig)
### -----figure1 over--------------------------------
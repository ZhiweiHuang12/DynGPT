...
plt.tight_layout()
plt.savefig(figure_path+"Sfigure3_b.jpg",dpi=400)
plt.savefig(figure_path+"Sfigure3_b.eps",dpi=400)
plt.savefig(figure_path+"Sfigure3_b.pdf",dpi=400)
plt.close()
...
for i in file_index_all[:9]:
    ...
    plt.savefig(figure_path + "Sfigure3_c_{}_{}.jpg".format(i,file_index[0]))
    plt.savefig(figure_path + "Sfigure3_c_{}_{}.pdf".format(i,file_index[0]),bbox_inches="tight",dpi=600)
    plt.savefig(figure_path + "Sfigure3_c_{}_{}.eps".format(i,file_index[0]),bbox_inches="tight")

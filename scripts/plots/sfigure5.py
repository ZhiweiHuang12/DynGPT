...
plt.tight_layout()
plt.savefig(figure_path+"Sfigure5_b.jpg",dpi=400)
plt.savefig(figure_path+"Sfigure5_b.eps")
plt.savefig(figure_path+"Sfigure5_b.pdf")
plt.close()
...
for i in figure_li:
    ...
    plt.savefig(figure_path + "Sfigure5_c_{}.jpg".format(file_index[0]))
    plt.savefig(figure_path + "Sfigure5_c_{}.pdf".format(file_index[0]),bbox_inches="tight",dpi=600)
    plt.savefig(figure_path + "Sfigure5_c_{}.eps".format(file_index[0]),bbox_inches="tight")

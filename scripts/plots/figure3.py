...
plt.tight_layout()
plt.savefig(figure_path+"figure3_c.jpg",dpi=400)
plt.savefig(figure_path+"figure3_c.eps",dpi=400)
plt.savefig(figure_path+"figure3_c.pdf",dpi=400)
plt.close()
...
plt.tight_layout()
plt.savefig(figure_path+"{}_figure3_b.jpg",dpi=400)
plt.savefig(figure_path+"{}_figure3_b.eps",dpi=400)
plt.savefig(figure_path+"{}_figure3_b.pdf",dpi=400)
plt.close()
...
for k in range(37,40,1):
    ...
    plt.tight_layout()
    plt.savefig(figure_path + "figure3d_{}.jpg".format(file_index[0]),dpi=400)
    plt.savefig(figure_path + "figure3d_{}.pdf".format(file_index[0]))
    plt.savefig(figure_path + "figure3d_{}.eps".format(file_index[0]))

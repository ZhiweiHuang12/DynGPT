...
## reference code
sub_col_index = [1,2]
file_index_all = list(range(0,10))
...
for i in file_index_all:
    ...
    plt.savefig(figure_path + "{}_{}_Sfigure3_c_{}_{}.jpg".format(sub_col_index[0],model_type,i,file_index[0]))
    plt.savefig(figure_path + "{}_{}_Sfigure3_c_{}_{}.pdf".format(sub_col_index[0],model_type,i,file_index[0]),bbox_inches="tight",dpi=600)
    plt.savefig(figure_path + "{}_{}_Sfigure3_c_{}_{}.eps".format(sub_col_index[0],model_type,i,file_index[0]),bbox_inches="tight")
